...
var TrendPlaneteComponent = /** @class */ (function () {
    ...
    TrendPlaneteComponent = __decorate([
        Component({
            ...
            templateUrl: './trend-planete.component.html',
            styleUrls: ['./trend-planete.component.css']
        }),
        __metadata("design:paramtypes", [])
    ], TrendPlaneteComponent);
    return TrendPlaneteComponent;
}());
export { TrendPlaneteComponent };
//# sourceMappingURL=trend-planete.component.js.map