...
export class TrendComponent implements OnInit {
  ...
  title2:string = "You are travelling for business purposes, this planet offers all the comfort you will need: meeting room for virtual conferences, automatized desk concierge, and many more services. Located very close from the most influent companies of the galaxy, you will conduct your business in the best conditions.";
